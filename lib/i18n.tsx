...
const dict: Bundle = {
  fr: {
    ...
    'team.title': 'Deux fondateurs. Une exigence.',
    'team.body':
      'NOVAXIS n’est pas une rencontre de hasard. C’est l’alliance délibérée, à Rabat Agdal, d’un architecte logiciel passé par les plus grands groupes européens et d’un commissaire aux comptes fort de vingt ans de terrain. Deux signatures, une seule exigence.',
    'team.label.experience': 'Parcours',
    'team.label.stack': 'Expertise',
    'team.label.education': 'Formation',
    'team.label.present': 'aujourd’hui',
    'team.label.founder': 'Fondateur',
    'team.role.cto': 'Co-fondateur · CTO',
    'team.role.expert': 'Co-fondateur · Associé',
    'team.f1.title': 'Architecte de systèmes critiques pour groupes européens',
    'team.f2.title': 'Expert-comptable · Commissaire aux comptes',
    'team.f1.tagline':
      'Treize ans à concevoir et diriger des plateformes critiques — identité, paiements, microservices — pour Europcar, Renault et happn. Il met aujourd’hui cette ingénierie de pointe au service de la souveraineté numérique marocaine.',
    'team.f2.tagline':
      'Vingt ans d’audit légal et de commissariat aux comptes au Maroc. Fondateur du cabinet SB Partners, il garantit que chaque décision de NOVAXIS reste conforme, traçable et défendable — devant un juge comme devant l’administration fiscale.',
    'team.f1.cred.1': 'Lead technique · équipes jusqu’à 8 ingénieurs',
    'team.f1.cred.2': 'Europcar · Renault · happn · relevanC',
    'team.f1.cred.3': 'IAM · microservices · IA générative',
    'team.f2.cred.1': 'Commissaire aux comptes inscrit',
    'team.f2.cred.2': 'Fondateur du cabinet SB Partners',
    'team.f2.cred.3': 'Normes OHADA · CGI · IFRS',
  ...
  en: {
    ...
    'team.title': 'Two founders. One standard.',
    'team.body':
      'NOVAXIS is no coincidence. It is the deliberate alliance, in Rabat Agdal, of a software architect shaped by Europe’s largest groups and a statutory auditor with twenty years in the field. Two signatures, one standard.',
    ...
    'team.role.expert': 'Co-founder · Partner',
    'team.f1.title': 'Architect of mission-critical systems for European groups',
    'team.f2.title': 'Chartered accountant · Statutory auditor',
    'team.f1.tagline':
      'Thirteen years designing and leading mission-critical platforms — identity, payments, microservices — for Europcar, Renault and happn. He now puts that frontier engineering at the service of Morocco’s digital sovereignty.',
    'team.f2.tagline':
      'Twenty years of legal audit and statutory work in Morocco. Founder of the SB Partners firm, he ensures every NOVAXIS decision stays compliant, traceable and defensible — before a judge or the tax authority.',
    'team.f1.cred.1': 'Tech lead · teams up to 8 engineers',
    'team.f1.cred.2': 'Europcar · Renault · happn · relevanC',
    'team.f1.cred.3': 'IAM · microservices · generative AI',
    'team.f2.cred.1': 'Registered statutory auditor',
    'team.f2.cred.2': 'Founder of the SB Partners firm',
    'team.f2.cred.3': 'OHADA · CGI · IFRS standards',
  ...
  ar: {
    ...
    'team.title': 'مؤسّسان. معيار واحد.',
    'team.body':
      'NOVAXIS ليست صدفة. إنها تحالف مقصود، في الرباط أكدال، بين مهندس برمجيات صقلته كبرى المجموعات الأوروبية وخبير محاسب مدقّق قانوني بعشرين عامًا من الخبرة الميدانية. توقيعان، ومعيار واحد.',
    'team.label.experience': 'المسار',
    'team.label.stack': 'الخبرة',
    'team.label.education': 'التكوين',
    'team.label.present': 'الآن',
    'team.label.founder': 'مؤسّس',
    'team.role.cto': 'شريك مؤسس · مدير تقني',
    'team.role.expert': 'شريك مؤسس · شريك',
    'team.f1.title': 'مهندس أنظمة حسّاسة لمجموعات أوروبية',
    'team.f2.title': 'خبير محاسب · مدقّق قانوني',
    'team.f1.tagline':
      'ثلاثة عشر عامًا في تصميم وقيادة منصّات حسّاسة — الهوية والمدفوعات والخدمات المصغّرة — لـ Europcar وRenault وhappn. واليوم يضع هذه الهندسة المتقدّمة في خدمة السيادة الرقمية المغربية.',
    'team.f2.tagline':
      'عشرون عامًا من التدقيق القانوني والمراجعة في المغرب. مؤسّس مكتب SB Partners، يضمن أن يبقى كل قرار في NOVAXIS مطابقًا وقابلاً للتتبّع والدفاع عنه أمام القضاء والإدارة الضريبية.',
    'team.f1.cred.1': 'قائد تقني · فرق حتى 8 مهندسين',
    'team.f1.cred.2': 'Europcar · Renault · happn · relevanC',
    'team.f1.cred.3': 'إدارة الهوية · خدمات مصغّرة · ذكاء توليدي',
    'team.f2.cred.1': 'مدقّق قانوني معتمد',
    'team.f2.cred.2': 'مؤسّس مكتب SB Partners',
    'team.f2.cred.3': 'معايير OHADA · CGI · IFRS',
