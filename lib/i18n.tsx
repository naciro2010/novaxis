...
const dict: Bundle = {
  fr: {
    ...
    'team.body':
      'NOVAXIS réunit, à Rabat Agdal, une équipe de plus de 17 ingénieurs en informatique et des experts du chiffre. Deux signatures, une seule exigence : la fiabilité.',
    'team.label.founder': 'Fondateur',
    'team.role.cto': 'Co-fondateur',
    'team.role.expert': 'Co-fondateur',
    'team.f1.title': 'Experts en systèmes d’information',
    'team.f2.title': 'Expert dans son domaine',
    'team.f1.tagline':
      'Il pilote une équipe de plus de 17 ingénieurs en informatique, au service de la souveraineté numérique marocaine.',
    'team.f2.tagline':
      'Il veille à ce que chaque décision de NOVAXIS reste rigoureuse, conforme et défendable.',
    'team.stat.1': 'ingénieurs en informatique',
    'team.stat.2': 'expertises fusionnées',
  ...
  en: {
    ...
    'team.body':
      'NOVAXIS brings together, in Rabat Agdal, a team of 17+ software engineers and finance experts. Two signatures, one standard: reliability.',
    'team.label.founder': 'Founder',
    'team.role.cto': 'Co-founder',
    'team.role.expert': 'Co-founder',
    'team.f1.title': 'Information systems experts',
    'team.f2.title': 'Expert in his field',
    'team.f1.tagline':
      'He leads a team of 17+ software engineers, serving Morocco’s digital sovereignty.',
    'team.f2.tagline':
      'He ensures every NOVAXIS decision stays rigorous, compliant and defensible.',
    'team.stat.1': 'software engineers',
    'team.stat.2': 'fused expertises',
  ...
  ar: {
    ...
    'team.eyebrow': '08 — الفريق',
    'team.title': 'مؤسّسان. معيار واحد.',
    'team.body':
      'يجمع NOVAXIS، في الرباط أكدال، فريقًا من أكثر من 17 مهندسًا في المعلوميات وخبراء في المحاسبة. توقيعان، ومعيار واحد: الموثوقية.',
    'team.label.founder': 'مؤسّس',
    'team.role.cto': 'شريك مؤسس',
    'team.role.expert': 'شريك مؤسس',
    'team.f1.title': 'خبراء في نظم المعلومات',
    'team.f2.title': 'خبير في مجاله',
    'team.f1.tagline':
      'يقود فريقًا من أكثر من 17 مهندسًا في المعلوميات، في خدمة السيادة الرقمية المغربية.',
    'team.f2.tagline':
      'يحرص على أن يبقى كل قرار في NOVAXIS دقيقًا ومطابقًا وقابلاً للدفاع عنه.',
    'team.stat.1': 'مهندسًا في المعلوميات',
    'team.stat.2': 'تخصّصان مندمجان',
